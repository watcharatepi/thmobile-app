...
(function() {
    ...
    app.controller("HomeProductController", ['$http', '$element', '$scope', 'ShareComponents', function($http, element, $scope, sharedComponents) {
            ...
            $http.get('http://mobile.unicity-th.com/wp-admin/admin-ajax.php?action=unimobiapp_get_products&args[meta_key]=product_hot&args[meta_value]=yes').success(function(response) {
